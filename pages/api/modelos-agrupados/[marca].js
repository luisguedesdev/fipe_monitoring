...
function extrairNomeBase(nomeCompleto) {
  ...
  const palavrasVersao = [
    "GL", "GLX", "GLS", "SE", "SEL", "XL", "XLS", "XLT", "LX", "EX", "EXL", "DX",
    "Limited", "Titanium", "Platinum", "Freestyle", "Storm", "Raptor", "Black",
    "Sport", "Style", "Plus", "Premium", "Advance", "Advanced",
    "1.0", "1.2", "1.3", "1.4", "1.5", "1.6", "1.8", "2.0", "2.2", "2.3", "2.4", "2.5",
    "2.7", "2.8", "3.0", "3.2", "3.5", "3.6", "3.8", "3.9", "4.0", "4.2", "4.9", "5.0",
    "V6", "V8", "16V", "8V", "12V", "20V", "24V",
    "4x2", "4x4", "AWD", "FWD", "CD", "CS", "CE",
    "Flex", "Diesel", "Gasolina", "TB", "TDCI", "Turbo", "TDI",
    "Aut", "Aut.", "Mec", "Mec.",
    "8v", "16v",
    "i",
    "MPI", "EcoBoost", "TiVCT", "GTDI"
  ];
  ...
  for (const palavra of palavras) {
    ...
    if (palavrasVersao.some(v => palavra.toUpperCase().startsWith(v.toUpperCase())) ||
        /^\d/.test(palavra)) {
      break;
    }
